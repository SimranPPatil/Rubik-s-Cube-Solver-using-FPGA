...
module nios_system_mm_interconnect_0 (
	...
	wire   [13:0] cmd_mux_006_src_channel;                                                            // cmd_mux_006:src_channel -> accumulate_s1_agent:cp_channel
	...
	wire          cmd_mux_007_src_valid;                                                              // cmd_mux_007:src_valid -> clear_s1_agent:cp_valid
	wire  [106:0] cmd_mux_007_src_data;                                                               // cmd_mux_007:src_data -> clear_s1_agent:cp_data
	wire          cmd_mux_007_src_ready;                                                              // clear_s1_agent:cp_ready -> cmd_mux_007:src_ready
	wire   [13:0] cmd_mux_007_src_channel;                                                            // cmd_mux_007:src_channel -> clear_s1_agent:cp_channel
	wire          cmd_mux_007_src_startofpacket;                                                      // cmd_mux_007:src_startofpacket -> clear_s1_agent:cp_startofpacket
	wire          cmd_mux_007_src_endofpacket;                                                        // cmd_mux_007:src_endofpacket -> clear_s1_agent:cp_endofpacket
	...
	wire          clear_s1_agent_rp_valid;                                                            // clear_s1_agent:rp_valid -> router_009:sink_valid
	wire  [106:0] clear_s1_agent_rp_data;                                                             // clear_s1_agent:rp_data -> router_009:sink_data
	wire          clear_s1_agent_rp_ready;                                                            // router_009:sink_ready -> clear_s1_agent:rp_ready
	wire          clear_s1_agent_rp_startofpacket;                                                    // clear_s1_agent:rp_startofpacket -> router_009:sink_startofpacket
	wire          clear_s1_agent_rp_endofpacket;                                                      // clear_s1_agent:rp_endofpacket -> router_009:sink_endofpacket
	...
	wire          clear_s1_agent_rdata_fifo_src_valid;                                                // clear_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_007:in_0_valid
	wire   [33:0] clear_s1_agent_rdata_fifo_src_data;                                                 // clear_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_007:in_0_data
	wire          clear_s1_agent_rdata_fifo_src_ready;                                                // avalon_st_adapter_007:in_0_ready -> clear_s1_agent:rdata_fifo_src_ready
	wire          avalon_st_adapter_007_out_0_valid;                                                  // avalon_st_adapter_007:out_0_valid -> clear_s1_agent:rdata_fifo_sink_valid
	wire   [33:0] avalon_st_adapter_007_out_0_data;                                                   // avalon_st_adapter_007:out_0_data -> clear_s1_agent:rdata_fifo_sink_data
	wire          avalon_st_adapter_007_out_0_ready;                                                  // clear_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_007:out_0_ready
	wire    [0:0] avalon_st_adapter_007_out_0_error;                                                  // avalon_st_adapter_007:out_0_error -> clear_s1_agent:rdata_fifo_sink_error
